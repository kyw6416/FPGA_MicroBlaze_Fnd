...
HD_PWD='D:/FPGA/MicroBlaze_Fnd/MicroBlaze_Fnd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlaze_Fnd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_MicroBlaze_Fnd_wrapper.tcl
