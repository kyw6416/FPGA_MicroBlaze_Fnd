...
HD_PWD='D:/FPGA/MicroBlaze_Fnd/MicroBlaze_Fnd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlaze_Fnd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_MicroBlaze_Fnd_wrapper.tcl -notrace
