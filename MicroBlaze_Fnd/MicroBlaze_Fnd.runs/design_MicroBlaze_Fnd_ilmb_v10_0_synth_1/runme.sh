...
HD_PWD='D:/FPGA/MicroBlaze_Fnd/MicroBlaze_Fnd.runs/design_MicroBlaze_Fnd_ilmb_v10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_MicroBlaze_Fnd_ilmb_v10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_MicroBlaze_Fnd_ilmb_v10_0.tcl
